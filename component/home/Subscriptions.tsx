...
const Subscriptions = () => {
    return (
        <section id='subscription' className='container mx-auto px-4 lg:flex pb-20'>
            <div className='bg-primary py-10 pl-10 pr-20 rounded-t-2xl lg:rounded-l-2xl lg:rounded-t-none flex-1'>
                <p className='text-[#d2d9e5] font-semibold'>Pimjo Community</p>
                <h2 className='text-[#b5b1ff] text-3xl leading-10 my-6'>Connect with Builders and Pimjo Users on Discord!</h2>
            ...
            <div className='bg-[#13161F] py-10 px-5 lg:px-20 rounded-b-2xl lg:rounded-r-2xl lg:rounded-bl-none flex-1'>
                ...
                <h2 className='text-[#F9FAFA] font-bold text-xl leading-7 my-5 lg:my-6'>Stay in the loop with fresh updates, exclusive offers, and the latest product news—delivered right to your inbox!</h2>
